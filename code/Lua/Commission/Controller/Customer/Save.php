...
class Save extends \Lua\Commission\Controller\Customer
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $ticket->setStatus(\Lua\Commission\Model\Ticket::STATUS_OPENED);
            $ticket->save();
            ...
            $transport = $this->transportBuilder
                ->setTemplateIdentifier($this->scopeConfig->getValue('lua_commission/email_template/store_owner', $storeScope))
                ->setTemplateOptions(
                    [
